<template>
    <div class="row">
                    ...
                    <form>                        
                        <div class="row">
                            ...
                            <div id="btnCadastrarCliente" class="input-field right">
                                <a v-on:click="adicionaCliente" class="waves-effect waves-light btn blue lighten-2 btn-small">Cadastrar</a>
                            </div>
                            <div id="btnAtualizarCliente" class="input-field right">
                                <a v-on:click="alteraCliente" class="waves-effect waves-light btn blue lighten-2 btn-small">Atualizar</a>
                            </div>
        ...
        <meu-loader id="loaderClientesHyperspace"></meu-loader>
    </div>
</template>
...
//Models
import Cliente from '../../../classes/model/Hyperspace/Cliente.js';
...
export default {
    ...
    methods:{
        ...
        aguarde(){
            let loader = document.getElementById("loaderClientesHyperspace");
        ...
        adicionaCliente(){
            ...
            if(nomeCliente.value != ""){
                ...
                let cliente = new Cliente(0, nomeCliente.value, true);
        ...
        alteraCliente(){
            ...
            if(nome != ""){
                ...
                this.clienteAlteracao.Nome = nome;
        ...
        preencheTabela(pagina){
            ...
            clienteService.consultaTodos(pagina)
                .then(clientes => {
                    ...
                    this.arrayClientes = clientes.Empresas;

                    clientes.Empresas.forEach(cliente => {
                        this.corpos.push({"id": cliente.Id_Empresa, "valor": [cliente.Codigo_Empresa, cliente.Nome]});
                    });
    ...
    data(){
        return{
            ...
            //Tabela
            titulos: ['Código da Empresa', 'Nome'],
            corpos: [],
            acoes: true,
        }
    },
