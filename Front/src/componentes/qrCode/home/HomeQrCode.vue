<template>
    <div class="row">    
        ...
        <div class="row">
            ...
            <meu-cardColorido v-on:navegar="navegaUsuarios" :classe="classeCardColorido2" :idElemento="idElemento" :textos="textosCardColorido2" id="cardUsuarios" class="cards"></meu-cardColorido>
            <meu-cardColorido v-on:navegar="navegaQrs" :classe="classeCardColorido3" :idElemento="idElemento" :textos="textosCardColorido3" id="qrGerados" class="cards"></meu-cardColorido>
        </div>   
        <meu-card :classe="tamanhoGraficoLinhas" :header="headerCardLinhas" class="cardGrafico">
            <div class="divGrafico">
                <canvas id="graficoRequisicoesLinhaQrCode"></canvas>
            </div> 
        </meu-card> 
        <meu-card :classe="tamanhoGraficoPizza" :header="headerCardPizza" class="cardGrafico">
            <div class="divGrafico">
                <canvas id="graficoRequisicoesPizzaQrCode"></canvas>
            </div> 
        </meu-card> 
        <meu-loader id="loaderHomeQr"></meu-loader> 
    </div>
</template>
...
export default {
    ...
    methods: {
        createChart(chartId, chartData) {
            ...
            if(chartId == 'graficoRequisicoesLinhaQrCode'){
        ...
        aguarde(){
            let loader = document.getElementById("loaderHomeQr");
        ...
        navegaClientes(){
            this.$router.push({ name: 'clientesQrCode' });
        },

        navegaUsuarios(){
            this.$router.push({ name: 'usuariosQrCode' });
        },

        navegaQrs(){
            this.$router.push({ name: 'testeQrCode' });
        },

        montaTela(data, dia, tipo){
            if(document.getElementById("loaderHomeQr") != undefined){
                this.aguarde();	
            }

            let dashBoardService = new DashBoardServiceQrCode(this.$router);
            dashBoardService.dashboard(data, dia)
                .then(dados => 
                {
                    this.textosCardColorido1.destaque = dados.QuantidadeClientes;
                    this.textosCardColorido2.destaque = dados.QuantidadeUsuarios;
                    ...
                    if(tipo == 1){
                        this.createChart('graficoRequisicoesLinhaQrCode', graficoLinha.geraGraficoLinha());
                        this.createChart('graficoRequisicoesPizzaQrCode', graficoPizza.geraGraficoPizza());
                    }
                    else{
    ...
    data(){
        return{
            ...
            //Card colorido
            classeCardColorido1: "col s10 m7 l3 xl3 offset-m2 infoGeralQrCode",
            classeCardColorido2: "col s10 m7 l3 xl3 offset-xl1 offset-l1 offset-m2 infoGeralQrCode",
            classeCardColorido3: "col s10 m7 l3 xl3 offset-xl1 offset-l1 offset-m2 infoGeralQrCode",
            ...
            textosCardColorido2: {
                titulo: "Usuários",
                destaque: "",
                complementoDestaque: "Usuários"
            },
            textosCardColorido3: {
                titulo: "Qr Codes",
                destaque: "",
                complementoDestaque: "Qr Codes"
            },
