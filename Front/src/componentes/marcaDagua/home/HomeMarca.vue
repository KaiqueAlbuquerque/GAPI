<template>
    <div class="row">    
        ...
        <div class="row">
            ...
            <meu-cardColorido v-on:navegar="navegaMarcas" :classe="classeCardColorido3" :idElemento="idElemento" :textos="textosCardColorido3" id="marcasFeitas" class="cards"></meu-cardColorido>
        </div>   
        ...
        <meu-loader id="loaderHomeMarca"></meu-loader>    
    </div>
</template>
...
export default {
    ...
    methods: {
        createChart(chartId, chartData) {
            ...
            if(chartId == 'graficoRequisicoesLinhaMarca'){
        ...
        aguarde(){
            let loader = document.getElementById("loaderHomeMarca");
        ...
        navegaClientes(){
            this.$router.push({ name: 'clientesMarca' });
        },

        navegaUsuarios(){
            this.$router.push({ name: 'usuariosMarca' });
        },

        navegaMarcas(){
            this.$router.push({ name: 'testeMarca' });
        },

        montaTela(data, dia, tipo){
            if(document.getElementById("loaderHomeMarca") != undefined){
                this.aguarde();	
            }

            let dashBoardService = new DashBoardServiceMarcaDagua(this.$router);
    ...
    data(){
        return{
            ...
            //Card colorido
            classeCardColorido1: "col s10 m7 l3 xl3 offset-m2 infoGeralMarca",
            classeCardColorido2: "col s10 m7 l3 xl3 offset-xl1 offset-l1 offset-m2 infoGeralMarca",
            classeCardColorido3: "col s10 m7 l3 xl3 offset-xl1 offset-l1 offset-m2 infoGeralMarca",
            ...
            textosCardColorido3: {
                titulo: "Marcas D'agua",
                destaque: "",
                complementoDestaque: "Marcas"
            },
