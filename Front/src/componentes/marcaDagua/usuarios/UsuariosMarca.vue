<template>
    <div class="row">
                    ...
                    <form>
                        ...
                        <div class="row">
                            <div id="btnCadastrarUsuario" class="input-field right">
                                <a v-on:click="cadastrarUsuario" class="waves-effect waves-light btn red darken-4 btn-small">Cadastrar</a>
                            </div>
                            <div id="btnAtualizarUsuario" class="input-field right">
                                <a v-on:click="alteraUsuario" class="waves-effect waves-light btn red darken-4 btn-small">Atualizar</a>
                            </div>
        ...
        <meu-loader id="loaderUsuariosMarca"></meu-loader>
    </div>
</template>
...
import UsuarioService from '../../../classes/services/marcaDagua/UsuarioService.js';
...
export default {
    ...
    methods: {
        ...
        aguarde(){
            let loader = document.getElementById("loaderUsuariosMarca");
