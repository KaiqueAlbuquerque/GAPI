<template>
    <div class="row">
                    ...
                    <form>                        
                        <div class="row">
                            ...
                            <div id="btnCadastrarCliente" class="input-field right">
                                <a v-on:click="adicionaCliente" class="waves-effect waves-light btn red darken-4 btn-small">Cadastrar</a>
                            </div>
                            <div id="btnAtualizarCliente" class="input-field right">
                                <a v-on:click="alteraCliente" class="waves-effect waves-light btn red darken-4 btn-small">Atualizar</a>
                            </div>
        ...
        <meu-loader id="loaderClientesMarca"></meu-loader>
    </div>
</template>
...
//Models
import Cliente from '../../../classes/model/MarcaDagua/Cliente.js';

//Serviços
import ClienteService from '../../../classes/services/marcaDagua/ClienteService.js';
...
export default {
    ...
    methods:{
        ...
        aguarde(){
            let loader = document.getElementById("loaderClientesMarca");
        ...
        adicionaCliente(){
            ...
            if(nomeCliente.value != ""){
                ...
                let cliente = new Cliente(0, nomeCliente.value, true, 1);
        ...
        alteraCliente(){
            ...
            if(nome != ""){
                ...
                this.clienteAlteracao.NomeCliente = nome;
