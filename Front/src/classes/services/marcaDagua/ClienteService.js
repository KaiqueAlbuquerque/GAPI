...
export default class ClienteService extends MarcaDaguaServiceBase{
    constructor(rotas){
        super();
        this._rotas = rotas;   
    }
    ...
    consultaTodos(pagina){
        ...
        return fetch(`${this._url}Cliente/ConsultaClientes?idApiPertencente=1&pagina=${pagina}`, {
            headers: new Headers({
                'Authorization': `Bearer ${this._token}`, 
                'Content-type' : 'application/json'
            })
    ...
    consultaTodosCombo(){
        ...
        return fetch(`${this._url}Cliente/ConsultaClientes?idApiPertencente=1`, {
            headers: new Headers({
                'Authorization': `Bearer ${this._token}`, 
                'Content-type' : 'application/json'
            })
