...
namespace ApiAlteraPDF.Controllers
{
    ...
    public class MarcadAguaController : ApiController
    {
        private readonly IIntermediadorLog _logIntermediador;
        private readonly IIntermediadorUsuario _usuarioIntermediador;

        public MarcadAguaController(IIntermediadorLog logIntermediador, IIntermediadorUsuario usuarioIntermediador)
        {
